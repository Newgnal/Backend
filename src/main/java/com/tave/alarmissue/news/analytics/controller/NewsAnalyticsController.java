...
public class NewsAnalyticsController {
    ...
    public ResponseEntity<SentimentNewsResponse> getRecentMonthAnalytics() {
        SentimentNewsResponse response = analyticsService.getRecentMonthAnalytics();
    ...
    public ResponseEntity<SentimentNewsResponse> getAnalyticsByPeriod(
        ...
        SentimentNewsResponse response = analyticsService.getAnalyticsBetween(startDate, endDate);
        return ResponseEntity.ok(response);
    }
