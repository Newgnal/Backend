...
public class LikeService {
    ...
    @Transactional
    public LikeResponseDto postLike(LikeCreateRequestDto dto, Long userId, Long postId) {
    ...
    @Transactional
    public LikeResponseDto commentLike(LikeCreateRequestDto dto, Long userId, Long postId, Long commentId) {
        UserEntity user = userRepository.findById(userId).
                orElseThrow(() -> new LikeException(USER_ID_NOT_FOUND,"유저가 없습니다."));
